...
!
      ...
      write(6,*)' CICE (cice_init) 1    jobnum = ',jobnum
      write(6,*)' CICE (cice_init) 1   inidate = ',inidate
      write(6,*)' CICE (cice_init) 1 init_date = ',init_date
      write(6,*)' CICE (cice_init) 1  runtime0 = ',runtime0
      write(6,*)' CICE (cice_init) 1   runtime = ',runtime
      write(6,*)' CICE (cice_init) 1     idate = ',my_task, idate
#endif
      ...
      if (jobnum==1 .and. runtype == 'initial') then
        ...
        if (nrec == 0) nrec = 12 
        print *, 'CICE calling get_time0_sstsss... my_task = ',my_task
        call get_time0_sstsss('CICE_input/monthly_sstsss.nc', nrec)
        print *, 'CICE called  get_time0_sstsss. my_task = ',my_task
      endif
      ...
      if (gfdl_surface_flux) then
         call get_u_star('CICE_input/u_star.nc')
      endif  
#else
...
#ifdef AusCOM
      write(6,*) 'CICE (cice_init) 2      time = ', my_task, time
      write(6,*) 'CICE (cice_init) 2  runtime0 = ', my_task, runtime0
      write(6,*) 'CICE (cice_init) 2     idate = ', my_task, idate
      ...
      write(6,*) 'CICE (cice_init) 3     time = ', my_task, time
      write(6,*) 'CICE (cice_init) 3 runtime0 = ', my_task, runtime0
      write(6,*) 'CICE (cice_init) 3    idate = ', my_task, idate
#endif
