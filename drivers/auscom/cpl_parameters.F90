...
integer(kind=int_kind), parameter :: jpfldout = 18 !n_i2a+n_i2o ! total number of fields sent
integer(kind=int_kind), parameter :: jpfldin  = 19 !n_a2i+n_o2i ! total number of fields rcvd 
